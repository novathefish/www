...
if(!isset($_SESSION['current_account_role_id'])){
  header('Location: startbootstrap-sb-admin-2-gh-pages/login.php');
}
...
if(isset($_POST)){
  if(!empty($_POST['logout'])){
    unset($_SESSION['current_account_user_id']);
    unset($_SESSION['current_account_role_id']);
    unset($_SESSION['current_account_username']);
    header('Location: startbootstrap-sb-admin-2-gh-pages/login.php');
  }
}
?>
...
<div id="wrapper">
  ...
  <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item active">
      ...
      <?php
      if(isset($_SESSION['current_account_role_id'])){
        if($_SESSION['current_account_role_id'] == 4){
          echo '<a class="nav-link" href="universal/game.php">
    ...
    <div id="content">
      ...
      <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <?php
            if(isset($_SESSION['current_account_role_id'])){
              if($_SESSION['current_account_role_id'] == 1){
                echo '<li class="nav-item">
                      	<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <span class="mr-2 d-none d-lg-inline text-gray-600 small">'. $_SESSION['current_account_username'] .'</span>
              ...
              elseif ($_SESSION['current_account_role_id'] == 2) {
                echo '<li class="nav-item">
                      	<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <span class="mr-2 d-none d-lg-inline text-gray-600 small">'. $_SESSION['current_account_username'] .'</span>
                          <img class="img-profile rounded-circle" src="startbootstrap-sb-admin-2-gh-pages/img/undraw_profile.svg">
              ...
              elseif ($_SESSION['current_account_role_id'] == 3) {
                echo '<li class="nav-item">
                      	<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <span class="mr-2 d-none d-lg-inline text-gray-600 small">'. $_SESSION['current_account_username'] .'</span>
                          <img class="img-profile rounded-circle" src="startbootstrap-sb-admin-2-gh-pages/img/undraw_profile.svg">
              ...
              elseif ($_SESSION['current_account_role_id'] == 4) {
                echo '<li class="nav-item">
                      	<a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          <span class="mr-2 d-none d-lg-inline text-gray-600 small">'. $_SESSION['current_account_username'] .'</span>
                          <img class="img-profile rounded-circle" src="startbootstrap-sb-admin-2-gh-pages/img/undraw_profile.svg">
              ...
              echo '<li class="nav-item">
                      <a role="button" class="btn btn-primary" href="startbootstrap-sb-admin-2-gh-pages/login.php"">
                        <span class="mr-2 d-none d-lg-inline" style="style="color:#fff;">Log in</span>
                      </a>
                    	<!-- // Dropdown - User Information -->
                    	<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                        <a class="dropdown-item" href="#">
    ...
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"])?>" method="post" role="form">
          <input type="hidden" name="logout" class="btn btn-primary btn-user btn-block" value="logout"/>
          <input type="submit" name="submit" class="btn btn-primary btn-user btn-block" value="Logout"/>
        </form>
      </div>
    </div>
  </div>
